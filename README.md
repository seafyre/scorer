...
### Game Setup
- Starting scores: 301, 501, or 701
...
### Leg & Match Tracking
- Leg, set, and match cascade with automatic progression
- Starting player rotates each leg
- After each leg or set: per-player stats (darts thrown, average, top score)
...
- All settings and player names persist between sessions
...
Language can be changed in-app via Settings → Language, or in iOS Settings → Scorer → Language.
